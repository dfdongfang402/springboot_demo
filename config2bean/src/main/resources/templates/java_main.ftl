...
public class GenedMain {

public interface Checkable{
    void checkValid(java.util.Map<String,java.util.Map<Integer,? extends Object> > objs);
}
final static private org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(GenedMain.class);
...
<#list clientClassList as classname>
    ...
    if(o.getValue() instanceof confbeans.GenedMain.Checkable){
    try{
    ((confbeans.GenedMain.Checkable)o.getValue()).checkValid((java.util.Map
...
<#if !defineOnly>
    ...
    @SuppressWarnings("unchecked")
    public static java.util.Map<String,java.util.Map<Integer,? extends Object> > doConv(String outputdir,String outputdir2){
        ...
        try{
            <#list serverClassList as classname>
            objs.put("${classname}",${classname}.toXML(outputdir, xstream));
            </#list>
            <#list clientClassList as classname>
            objs.put("${classname}",${classname}.toXML(outputdir2, xstream));
            </#list>
    ...
    */
    public static void main(String[] args) throws Exception {
        ...
        doCheck(doConv(outputdir,outputdir2));
    }
</#if>
}
